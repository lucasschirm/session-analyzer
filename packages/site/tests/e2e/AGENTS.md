...
- **icon-rail.spec.ts** — UX-023/UX-024/UX-025: icon-rail navigation journey and active-route mapping (incl. nested routes), keyboard accessibility, `aria-current` semantics, and interim domain-page reachability via the `/artifacts` "Domain pages" link row.
