...
export interface AssistantEntry extends ClaudeCodeEntryBase {
  ...
  message: {
    ...
    usage?: {
      /** `null` when the source line omitted this field or reported a
       *  non-finite/malformed value — distinct from a measured `0`, per
       *  `.agents/rules/missing-is-never-zero.md` (#377). */
