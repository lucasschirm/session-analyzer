...
export const ENV_SAL_STORAGE_ID = 'SAL_STORAGE_ID';
export const ENV_SAL_STORAGE_SECRET = 'SAL_STORAGE_SECRET';
...
export type SyncEnvVar =
  ...
  | typeof ENV_SAL_STORAGE_ID
  | typeof ENV_SAL_STORAGE_SECRET
