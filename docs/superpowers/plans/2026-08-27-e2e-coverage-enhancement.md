...
| UX-027 | Left-nav expandable project sessions list and session direct navigation | `project-sessions.spec.ts` | session expansion, navigation assertion | 3 | 4 | 4 | 48 | P1 | GREEN |
| UX-028 | Dedicated project sessions page (`#/projects/:id/sessions`) pagination and filters | `project-sessions.spec.ts` | pagination, search, date range filter assertion | 3 | 4 | 4 | 48 | P1 | GREEN |
| UX-029 | Project sessions table navigation, title display, and subagent badge | `project-sessions.spec.ts` | table row click, session evidence routing assertion | 3 | 4 | 4 | 48 | P1 | GREEN |
| UX-030 | Session context growth chart interaction and message detail drawer focus trap | `project-sessions.spec.ts` | drawer open on bar click, focus trap, Escape to close | 3 | 4 | 4 | 48 | P1 | GREEN |
